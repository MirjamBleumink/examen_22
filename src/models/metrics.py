...
from sklearn.metrics import precision_score #toegevoegd Mirjam Bleumink tbv notebook 2 vraag 3
from sklearn.metrics import confusion_matrix #toegevoegd Mirjam Bleumink tbv notebook 2 vraag 3
...
#Mirjam Bleumink toegevoegd voor notebook 2 vraag 3
class Precision(Metric):
    ...
    def __call__(self, y:Tensor, yhat: Tensor) -> Tensor:
        yhat = yhat.argmax(dim=1)
        score = precision_score(y, yhat, average='macro')
        return torch.tensor(score)
